...
valid_drivers = set(data["results"][data["results"]["raceId"].isin(current_season_race_ids)]["driverId"].unique())
valid_circuits = set(races_df[races_df["raceId"].isin(current_season_race_ids)]["circuitId"].unique())
